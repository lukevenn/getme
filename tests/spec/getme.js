...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        exports.spec = factory;
    } else {
        factory(root.getme);
    }
}(this, function (getme, rootScope) {

    rootScope = rootScope || window; // to allow testing in node - defaults to window for browser
    ...
    describe('getme', function () {
        ...
        it('should return an object from a global object when passed a string', function () {
            rootScope.testObject = testObject;
            expect(getme('testObject.uk')).toBe(rootScope.testObject.uk);
            expect(getme('testObject.uk.london')).toBe(rootScope.testObject.uk.london);
        });
        ...
        it('should return a value from a global object when passed a string', function () {
            rootScope.testObject = testObject;
            expect(getme('testObject.world')).toBe(rootScope.testObject.world);
            expect(getme('testObject.uk.type')).toBe(rootScope.testObject.uk.type);
            expect(getme('testObject.uk.london.type')).toBe(rootScope.testObject.uk.london.type);
        });
        ...
        it('should return a function from a global object when passed a string', function () {
            rootScope.testObject = testObject;
            expect(getme('testObject.func')).toBe(rootScope.testObject.func);
            expect(getme('testObject.uk.getSize')).toBe(rootScope.testObject.uk.getSize);
            expect(getme('testObject.uk.london.getSize')).toBe(rootScope.testObject.uk.london.getSize);
        });
